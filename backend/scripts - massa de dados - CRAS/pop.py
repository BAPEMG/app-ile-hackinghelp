...
def main():
  ...
  url = 'http://aplicacoes.mds.gov.br/sagi/servicos/equipamentos?q=tipo_equipamento:%22CENTRO%20POP%22&wt=json&fl=id_equipamento,ibge,uf,cidade,nome,responsavel,telefone,endereco,numero,complemento,referencia,bairro,cep,data_atualizacao&rows=999999999'
